...
const App = () => {
  ...
  return (
    <>
      ...
      <div className="bg-fuchsia-400 h-screen px-4 !font-mono z-50">
        {!showCards ? (
          <div className="py-6 max-w-800 m-auto text-yellow-500">
            ...
            <p className="text-black text-lg font-bold pb-4">
              Espero que este dia sea tan especial y lleno de magia como tu ✨,
              y que te sientas extremadamente feliz, amado y bendecido, que la
              vida solo te regale las mejores sonrisas en cada uno de los dias q
              se vienen, y que cada uno de tus propositos los alcances sin
              tropiezos.
            </p>

            <p className="text-black text-lg font-bold pb-4">
              El cielo es el limite para ti bebe, y estoy segura que lo que se
              te viene es solo lo mejor de lo mejor, por que no hay nadie mas
          ...
          <div className="py-3">
            ...
            <p className="text-black text-lg font-bold my-8 max-w-800 m-auto">
              En un intento de ser creativa y darte una sorpresa en tu dia (Que
              no sera ni tan sorpresa despues de todo 🥲), he creado 3 opciones
              para que elijas la que mas te guste, y asi poder disfrutar de un
              🎁 que vaya mas acorde a ti y que te haga sentir mas especial y a
              gusto.
            </p>
